...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { company: @seller.company, email: @seller.email, job: @seller.job, name: @seller.name, phone: @seller.phone }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { company: @seller.company, email: @seller.email, job: @seller.job, name: @seller.name, phone: @seller.phone }
    assert_redirected_to seller_path(assigns(:seller))
  end
